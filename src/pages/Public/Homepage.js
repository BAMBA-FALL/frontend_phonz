...
import {CarouselProduct} from '../Public/CarouselProduct'
...
const Homepage = () => {
    ...
    //         try {
    //             const response = await homepageConfigService.getHomepageConfigs();
    //             setConfigs(response);

    //             const categoryResponse = await categoryService.getAllCategoriesWithSubcategories();
